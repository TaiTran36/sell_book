                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="form-group block_add_sub">
                                <input type="text" class="form-control name_subcategory" placeholder="Name subcategory" style="margin-right: 10px">
                                <button type="button" class="btn btn-primary mb-2 add_sub_cate name_sub">Add</button>
                            </div>
